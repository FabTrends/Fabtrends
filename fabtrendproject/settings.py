"""
Django settings for fabtrendproject project.
...
SECRET_KEY = '&+v2q+)-7ql+a&6kno*5$9ebic!dcw&4&zojas23y&=7$8+%d('
...
ROOT_URLCONF = 'fabtrendproject.urls'
...
WSGI_APPLICATION = 'fabtrendproject.wsgi.application'
